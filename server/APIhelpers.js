...
const get311 = () => { return new Promise((resolve, reject) => {
  ...
  // axios.get("https://data.nola.gov/resource/2jgv-pqrq.geojson?$where=date_created between '2019-10-10T09:00:00' and '2019-10-11T12:00:00'&request_type=Roads/Drainage")
    .then((response) => {
